...
import ar.com.sclmax.indumatics.gpstracker.EMF;
...
@Api(name = "deviceinfoendpoint", namespace = @ApiNamespace(ownerDomain = "com.ar", ownerName = "com.ar", packagePath = "sclmax.indumatics.gpstracker"))
